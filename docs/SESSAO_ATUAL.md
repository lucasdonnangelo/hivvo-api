...
**Próximo passo imediato:** Batch 1 do plano — consolidar a lógica de fatura/parcela em `app/services/` (T-04 + extração alvo do T-01).
...
*Última atualização: 10 de junho de 2026 — Fase migrada para Hardening pré-deploy após auditorias de segurança e técnica. Plano de 16 batches em `docs/PLANO_EXECUCAO_API.md`. Próximo: Batch 1 (consolidar lógica de domínio em services/).*
