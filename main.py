...
from app.routers import auth, transactions, categories, cards, invoices, installments, statistics, ai, recorrencias, import_fatura, import_extrato, feedback
...
app.include_router(feedback.router, prefix="/api/v1", dependencies=_csrf)
